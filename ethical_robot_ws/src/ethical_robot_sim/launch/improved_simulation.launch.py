...
def generate_launch_description():
    ...
    # Set the path to the world file - Use the improved world
    world_file_name = 'improved_dilemma_world.sdf'
    ...
    perception_node_cmd = Node(
        ...
        parameters=[
            ...
            # Updated coordinates to match the improved world
            {'area1_center_x': 18.0},
            {'area1_center_y': 9.0},
            {'area2_center_x': 18.0},
            {'area2_center_y': -9.0},
    ...
    # Start the extended robot controller instead of the original
