...
def generate_launch_description():
    ...
    # Set the path to the world file - Use the fixed world
    world_file_name = 'fixed_dilemma_world.sdf'
    ...
    perception_node_cmd = Node(
        ...
        parameters=[
            ...
            # Updated coordinates to match the fixed world
            {'area1_center_x': 25.0},
            {'area1_center_y': 30.0},
            {'area2_center_x': 25.0},
            {'area2_center_y': -30.0},
    ...
    # Start the faster robot controller
    robot_controller_cmd = Node(
        package='ethical_robot_sim',
        executable='fast_robot_controller',
        name='robot_controller',
        output='screen',
        parameters=[
            {'use_sim_time': use_sim_time},
            {'linear_speed': 1.0},       # Much faster speed
            {'angular_speed': 1.2},      # Faster turning
            {'obstacle_threshold': 0.5},
            {'goal_tolerance': 0.3},     # Increased tolerance
            {'decision_point_x': 10.0},  # Updated from world file
            {'decision_point_y': 0.0},
            # Updated coordinates to match the fixed world
            {'area1_x': 25.0},
            {'area1_y': 30.0}, 
    ...
    # Add the automatic decision maker
    auto_decision_maker_cmd = Node(
        package='ethical_robot_sim',
        executable='auto_decision_maker',
        name='auto_decision_maker',
        output='screen'
    )
    ...
    ld.add_action(auto_decision_maker_cmd)  # Add the auto decision maker
